...
public class ProcessWordCountTests {

    private TopologyTestDriver testDriver;
    public static final String INPUT_TOPIC = SpringCloudStreamKafkaStreamsApplication.processWordCount.INPUT_TOPIC;
    public static final String OUTPUT_TOPIC = SpringCloudStreamKafkaStreamsApplication.processWordCount.OUTPUT_TOPIC;

    final Serde<String> stringSerde = Serdes.String();
    final JsonSerde<SpringCloudStreamKafkaStreamsApplication.WordCount> countSerde = new JsonSerde<>(SpringCloudStreamKafkaStreamsApplication.WordCount.class);
    ...
    public void setup() {
        ...
        SpringCloudStreamKafkaStreamsApplication.processWordCount app = new SpringCloudStreamKafkaStreamsApplication.processWordCount();
        final Function<KStream<Bytes, String>, KStream<Bytes, SpringCloudStreamKafkaStreamsApplication.WordCount>> process = app.wordCount();

        final KStream<Bytes, SpringCloudStreamKafkaStreamsApplication.WordCount> output = process.apply(input);
     ...
     */
    private ProducerRecord<Bytes, SpringCloudStreamKafkaStreamsApplication.WordCount> readOutput() {
    ...
    private Map<String, Long> getOutputList() {
        ...
        ProducerRecord<Bytes, SpringCloudStreamKafkaStreamsApplication.WordCount> outputRow;
    ...
    public void testOneWord() {
        ...
        final ProducerRecord<Bytes, SpringCloudStreamKafkaStreamsApplication.WordCount> output = readOutput();
        assertThat(output).isNotNull();
        assertThat(output.value()).isEqualToComparingFieldByField(new SpringCloudStreamKafkaStreamsApplication.WordCount("hello", 1L, new Date(0), new Date(SpringCloudStreamKafkaStreamsApplication.processWordCount.WINDOW_SIZE_MS)));
